 ...
 * can receive.
 *
 * For this specific class you can test the activity by doing (see [CONTRIBUTING](https://github.com/tachiyomi-extensions-org/tachiyomi-extensions/blob/master/CONTRIBUTING.md#url-intent-filter)):
 * ```
